    ...
    if (url.pathname === "/bet") {
        ...
        for (const n of nums) {
            ...
            atomic = atomic.set(["bets", betId], { 
                ...
                time: txTime, rawMins: mins, batchId, date: txDate // Adding date for tracking
            });
        }
  ...
  return new Response(`
    ...
    <script>
        ...
        window.onload = function() {
            ...
            let totalWin = 0;
            bets.forEach(b => {
                if(b.dataset.status === "WIN" && b.dataset.date === today) {
