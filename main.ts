...
serve(async (req) => {
  ...
  if (isAdmin && req.method === "POST") {
      ...
      // FIX: Settings Logic Updated to correctly capture contact info
      if (url.pathname === "/admin/settings") {
         ...
         // Direct Check for Contact fields
         const kn = form.get("kpay_no");
         const wn = form.get("wave_no");
         if(kn !== null || wn !== null) {
             const c = {
                 kpay_no: form.get("kpay_no") || "", 
                 kpay_name: form.get("kpay_name") || "",
                 wave_no: form.get("wave_no") || "", 
                 wave_name: form.get("wave_name") || "",
