...
serve(async (req) => {
  ...
  return new Response(`
    ...
    <div id="voucherModal" class="fixed inset-0 z-[110] hidden flex items-center justify-center p-6"><div class="absolute inset-0 bg-black/90" onclick="closeVoucher()"></div>
      <div id="voucherCard" class="relative w-full max-w-xs bg-white text-slate-900 rounded-lg overflow-hidden shadow-2xl slide-up">
    ...
    <script>
        ...
        function saveVoucher() {
            const el = document.getElementById('voucherCard');
